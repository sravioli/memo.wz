Thanks for contributing to memo.wz.
...
- Feature:
  - Template file:
    https://github.com/sravioli/memo.wz/blob/main/.github/PULL_REQUEST_TEMPLATE/feature.md
  - Query parameter: `?template=feature.md`
- Bug fix:
  - Template file:
    https://github.com/sravioli/memo.wz/blob/main/.github/PULL_REQUEST_TEMPLATE/bug_fix.md
  - Query parameter: `?template=bug_fix.md`
- Documentation:
  - Template file:
    https://github.com/sravioli/memo.wz/blob/main/.github/PULL_REQUEST_TEMPLATE/documentation.md
...
```text
https://github.com/sravioli/memo.wz/compare/<branch-name>?template=feature.md
```
